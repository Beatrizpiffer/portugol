...
programa
{
	funcao inicio() 
	{
		inteiro soma = 0, valor, contador , preco , producao,metade_inteira, resto, venda, lucro
		
		escreva("Digite o preco : ") 
		leia(preco)

		escreva("Digite  venda : ")
		
		
	       (valor da producao = 100)
	

		metade_inteira = valor / 2 // Calcula a metade inteira do valor
		resto = valor % 10  // Calcula o resto da divisão do valor por 3
		para (contador = 0; contador <= valor; contador ++) 
		{
	      lucro = (preco - 100 ) / ( venda * 100 )}
